...
?>
<div id="cshero-header-inner" class="header-1 header-top header-trans <?php if(is_page() && !empty($opt_meta_options['custom_header']) && !empty($opt_meta_options['header_sticky_dark']) ) { echo 'header-nav-white-sticky'; } else { echo 'header-nav-white'; } ?> <?php echo whole_header_class_wrap(); ?>">
    <div id="cshero-header-wrapper">

        <div id="cshero-header-top">
            <div class="container">
                <div class="row">
                    <div class="top-sidebar-left col-xs-12 col-sm-12 col-md-7 col-lg-7 text-center-sm text-center-xs">
                        <?php dynamic_sidebar( 'top-sidebar-left' ); ?>
                    </div>
                    <div class="top-sidebar-right col-xs-12 col-sm-12 col-md-5 col-lg-5 text-center-sm text-center-xs text-right">
                        <?php dynamic_sidebar( 'top-sidebar-right' ); ?>
                    </div>
                </div>
            </div>
        </div>
