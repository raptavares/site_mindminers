...
?>
<div id="cshero-header-inner" class="header-1 no-header-top header-trans <?php if(is_page() && !empty($opt_meta_options['custom_header']) && !empty($opt_meta_options['header_sticky_dark']) ) { echo 'header-nav-white-sticky'; } else { echo 'header-nav-white'; } ?> <?php echo whole_header_class_wrap(); ?>">
