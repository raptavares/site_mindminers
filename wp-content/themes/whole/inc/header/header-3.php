...
?>
<div id="cshero-header-inner" class="header-3 no-header-top header-trans header-nav-white header-logo-center <?php echo whole_header_class_wrap(); ?>">
                        ...
                        <div class="cshero-header-navigation-inner clearfix">
                            ...
                            <div id="cshero-header-navigation-left" class="cshero-header-navigation">
                                <nav id="site-navigation" class="main-navigation">
                                    ...
                                    <?php whole_header_navigation_left(); ?>
                            ...
                            <div id="cshero-header-navigation-right" class="cshero-header-navigation">
                                ...
                                <nav id="site-navigation" class="main-navigation" role="navigation">
                                    ...
                                    <?php whole_header_navigation_right(); ?>
